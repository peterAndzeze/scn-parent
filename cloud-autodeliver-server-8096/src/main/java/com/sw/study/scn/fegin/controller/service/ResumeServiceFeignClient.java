package com.sw.study.scn.fegin.controller.service;
...
// 原来：http://resume-server/resume/openstate/ + userId;
// @FeignClient表明当前类是一个Feign客户端，value指定该客户端要请求的服务名称（登记到注册中心上的服务提供者的服务名称）
@FeignClient(value = "resume-server",fallback = ResumeFallback.class,path = "/resume")
